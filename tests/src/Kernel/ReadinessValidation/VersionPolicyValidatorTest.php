...
class VersionPolicyValidatorTest extends AutomaticUpdatesKernelTestBase {
  ...
  public function providerReadinessCheck(): array {
    ...
    return [
      ...
      // readiness error. The subsequent cases prove that updating from a
      // dev snapshot is never allowed, and that updating from an alpha, beta,
      // or RC release is only allowed (i.e., won't raise a readiness error) if
